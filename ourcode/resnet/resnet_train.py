...
with tf.Session() as sess:
    ...
    while datetime.datetime.now() < endtime:
        ...
        if step % step_display == 0:
            ...
            l, acc1, acc5 = sess.run([loss, accuracy1, accuracy5], feed_dict={x: images_batch, y: labels_batch}) 
            ...
            l, acc1, acc5 = sess.run([loss, accuracy1, accuracy5], feed_dict={x: images_batch_val, y: labels_batch_val}) 
        ...
        sess.run(train_optimizer, feed_dict={x: images_batch, y: labels_batch})
    ...
    for i in range(num_batch):
        ...
        acc1, acc5 = sess.run([accuracy1, accuracy5], feed_dict={x: images_batch, y: labels_batch})
        acc1_total += acc1
        acc5_total += acc5
